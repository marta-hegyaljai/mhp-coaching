...
/**
 * Window, search and reset in one hairline surface directly above the list, so
 * every state of the panel stays a shareable URL.
 */
export function ActivityToolbar({
  ...
  return (
    <Toolbar>
      <ToolbarRow className={toolbarGroupClass}>
        <SegmentedLinks
