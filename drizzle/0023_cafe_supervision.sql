-- Café Supervision: a CPD / group-supervision category, distinct from training
-- modules. Individual evening dates are published as ordinary course_sessions
-- so staff can open or close each one from the course record.
